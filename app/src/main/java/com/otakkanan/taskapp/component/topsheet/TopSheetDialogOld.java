 ...
 */
public class TopSheetDialogOld extends AppCompatDialog {

    private TopSheetBehavior<FrameLayout> topSheetBehavior;

    public TopSheetDialogOld(@NonNull Context context) {
        super(context, getThemeResId(context, 0));
        supportRequestWindowFeature(Window.FEATURE_NO_TITLE);
    }

    public TopSheetDialogOld(@NonNull Context context, @StyleRes int theme) {
    ...
    protected TopSheetDialogOld(@NonNull Context context, boolean cancelable,
