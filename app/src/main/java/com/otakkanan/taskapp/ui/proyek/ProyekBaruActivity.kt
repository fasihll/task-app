...
class ProyekBaruActivity : AppCompatActivity(),
    DatePicker.OnDateSelectedListener {
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            val jsonString = Helper.loadJSONFromAssets(this@ProyekBaruActivity, "task_dummy.json")
            ...
            with(binding){
                ...
                btnSelesai.setOnClickListener{
                    finish()
                    startActivity(Intent(this@ProyekBaruActivity,ProyekBaruActivity::class.java))
                }
        ...
        private fun setupDialogAddTugas(task: Task?) {
            ...
            val dialog = MaterialAlertDialogBuilder(this@ProyekBaruActivity)
                .setView(dialogView)
                .show()
            ...
            val layoutManager = LinearLayoutManager(this@ProyekBaruActivity, LinearLayoutManager
                .HORIZONTAL,false)
            ...
            val adapter = AnggotaAdapter { team ->
                ...
                val intent = Intent(this@ProyekBaruActivity, AnggotaActivity::class.java)
                intent.putParcelableArrayListExtra(
                    AnggotaActivity.TAG, ArrayList(task!!.team ?:
                emptyList()))
