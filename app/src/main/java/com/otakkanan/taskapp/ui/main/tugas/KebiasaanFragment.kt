...
@AndroidEntryPoint
class KebiasaanFragment : Fragment(), KebiasaanAdapter.OnTaskStatusChangeListener {

    private lateinit var recyclerView: RecyclerView
    private lateinit var adapter: KebiasaanAdapter
    ...
    override fun onCreateView(
        ...
        adapter = KebiasaanAdapter(allTasks, this)
